module.exports = {
    ...
    rules: {
        ...
        'no-restricted-syntax': [
            ...
            {
                selector: ':matches(ArrowFunctionExpression, FunctionExpression, FunctionDeclaration) > BlockStatement > IfStatement:first-child:last-child > BlockStatement[body.length>2]',
            ...
            {
                selector: 'ImportDeclaration[source.value=/\\.s?css$/i] ~ ImportDeclaration[importKind="value"][source.value!=/\\.s?css$/i]',
